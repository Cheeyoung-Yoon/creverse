...
from app.models.rubric import RubricItemResult, Correction, ScoreCorrectionFeedback, PreProcessResult
...
def test_aggregate_scf_basic():
    ...
    pre = PreProcessResult(word_count=120, meets_length_req=True, is_english=True, is_valid=True)
...
def test_aggregate_from_run_outputs():
    ...
    pre = PreProcessResult(word_count=30, meets_length_req=False, is_english=True, is_valid=False)
